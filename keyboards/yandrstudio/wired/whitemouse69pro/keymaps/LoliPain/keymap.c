...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SUPPLY] = LAYOUT(
		...
		_______, VIWINDOWS,_______, _______,         XXXXXXX,XXXXXXX, _______,_______, _______,_______, _______, _______,_______, KC_END),
	[_VIMOUSE] = LAYOUT(
	...
	[_VIWINDOWS] = LAYOUT(
		...
		_______, _______, _______, _______,         XXXXXXX,XXXXXXX, _______,_______, _______,_______, _______, _______,_______, _______),
	[_LOCKS] = LAYOUT(
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,LLOCK,   KC_NLCK,
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
