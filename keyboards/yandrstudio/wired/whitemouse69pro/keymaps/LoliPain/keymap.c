...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT(
		...
		KC_LCTL, KC_LGUI, KC_LALT, L_SPACE,         XXXXXXX,XXXXXXX, R_SPACE, SUPPLY,      KC_RALT,KC_LEFT, KC_DOWN, KC_RGHT,KC_P0,   KC_PDOT),
	...
	[_VIMABLE] = LAYOUT(
		...
		_______, _______, _______, _______, _______,_______,VIM_LEFT,VIM_DOWN,VIM_UP,  VIM_RIGHT,KC_BTN1,          _______,_______, _______,
    ...
    //
	[_LOCKS] = LAYOUT(
		LAYER_LOCK,    _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, KC_NLCK,
		_______,       _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
