...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,         XXXXXXX,XXXXXXX,  KC_SPC, SUPPLY,  KC_RALT,KC_LEFT, KC_DOWN, KC_RGHT,KC_P0,   KC_PDOT),
	// Double KC_NO in middle is used for non-existent on MiniCat knob (=
	[_SUPPLY] = LAYOUT(
		KC_PSCR, KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,   KC_F7,  KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_INS,
		_______, _______, _______, _______, _______,_______,_______, _______,_______, KC_LBLC,KC_RBLC, _______, _______,_______, KC_HOME,
	...
	[_VIMOUSE] = LAYOUT(
		...
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,KC_BTC2, _______, _______,_______, _______,
		_______, _______, _______, _______, _______,_______,KS_MS_L, KS_MS_D,KS_MS_U, KC_MS_R,KC_BTN1,          _______,_______, _______,
	...
	[_VIMOVEMENT] = LAYOUT(
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
		_______, _______, _______, _______, _______,_______,KS_LEFT, KS_DOWN,KS_UP,   KC_RGHT,_______,          _______,_______, _______,
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
		_______, _______, _______, _______,         XXXXXXX,XXXXXXX, _______,_______, _______,_______, _______, _______,_______, _______),
	[_VIWINDOWS] = LAYOUT(
		_______, _______, _______, _______, _______,_______,_______, _______,_______, _______,_______, _______, _______,_______, _______,
