...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SUPPLY] = LAYOUT(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, KC_MPRV, KC_MNXT,  KC_HOME,
		_______, _______, _______, _______, _______, _______, _______, _______, KC_SCLN, KC_QUOT, _______,          KC_MPLY, _______,  KC_PGUP,
